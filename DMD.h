...
#define PATTERN_ALT_0     0 // từng led sáng xe kẽ
#define PATTERN_ALT_1     1 // Đảo lại trạng thái PATTERN_ALT_0
#define PATTERN_STRIPE_0  2 // Cột sáng xen kẽ
#define PATTERN_STRIPE_1  3 // Đảo lại trạng thái PATTERN_STRIPE_0
