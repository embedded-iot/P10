...
/* 
drawString : Hiển thị 1 chuỗi
bX : cột thứ
bY: Hàng thứ
bChars : chuỗi hiển thị
bGraphicsMode : chế độ hiển thị
*/
...
/*
drawMarquee : chạy chữ
bChars : Nội dung chữ muốn chạy
length: độ dài chuỗi
left: Cột bắt đầu
top: Hàng bắt đầu (tính từ trên xuống)
*/
...
/*--------------------------------------------------------------------------------------
 ...
 bNormal =  true // Tất cả đều tắt
 bNormal = false; tất cả đều sáng
--------------------------------------------------------------------------------------*/
...
/*--------------------------------------------------------------------------------------
 ...
 drawLine : Vẽ 1 dòng từ x1,y1 đến x2,y2
--------------------------------------------------------------------------------------*/
...
/*--------------------------------------------------------------------------------------
 ...
 bPattern: 
        PATTERN_ALT_0     : led sáng xen kẽ
        PATTERN_ALT_1     :
        PATTERN_STRIPE_0  : cột sáng xen kẽ 
        PATTERN_STRIPE_1  :
--------------------------------------------------------------------------------------*/
...
/*
bX : hiển thị từ cột số
bY : hiển thị từ hàng số
letter : Ký tự muốn hiển thị
bGraphicsMode : 
    GRAPHICS_NORMAL : kiểu ký tự bình thường
    GRAPHICS_OR     : chữ sáng
    GRAPHICS_NOR    : chữ tối
    GRAPHICS_TOGGLE : đảo trạng thái chữ  
    GRAPHICS_INVERSE: dạng hiển thị ảnh
*/
